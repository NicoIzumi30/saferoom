            ...
            <div class="row">
                ...
                ">
                        ...
                        <ul class="dropdown-menu" style="padding-bottom: 0.5px">
                            ...
                            <li>
                                <a class="dropdown-item" data-toggle="modal" data-target="#logoutModal" href="#"><i class="fa-solid fa-right-from-bracket"></i>Log
                                    out</a>
                            </li>
                        </ul>
                    </div>
            ...
            <?php foreach ($room as $kamar) : ?>
                <div class="row mt-3">
                    <div class="imgHome">
                        ...
                        <div class="img1">
                            <img width="auto" height="auto" src="<?= base_url('assets/image/room/') ?><?= $img[0] ?>" class="" />
                        </div>
                        <div class="img2">
                            <img width="auto" height="auto" src="<?= base_url('assets/image/room/') ?><?= $img[1] ?>" class="" />
                            <img width="auto" height="auto" src="<?= base_url('assets/image/room/') ?><?= $img[2] ?>" class="igTop" />
                            <img width="auto" height="auto" src="<?= base_url('assets/image/room/') ?><?= $img[3] ?>" class="" />
                            <img width="auto" height="auto" src="<?= base_url('assets/image/room/') ?><?= $img[4] ?>" class="igBottom" />
                        </div>
                    </div>
                </div>
                <div class="row  mb-5">
                                ...
                                <table width="100%">
                                    ...
                                    <form action="<?= base_url('home/pemesanan/') ?>" method="post">
                                        ...
                                        <td id="tomorrow"></td> -->
                                                ...
                                                $date =  date('Y-m-d');
                                                ?>
                                                <td><input type="date" class="form-control" min="<?= $date ?>" max="<?= date('Y-m-d', strtotime($date . ' + 7 days')) ?>" name="checkin" id="checkin" required></td>
                                                <td><input type="date" class="form-control" min="<?= date('Y-m-d', strtotime($date . ' + 1 days')) ?>" max="<?= date('Y-m-d', strtotime($date . ' + 14 days')) ?>" name="checkout" id="checkout" required></td>
                                            </tr>
                                        </tbody>
                                </table>
                            </div>
