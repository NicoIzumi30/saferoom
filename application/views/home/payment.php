                    ...
                    <div class="dropdown mt-2">
                        ...
                        <ul class="dropdown-menu" id="profile">
                            ...
                            <li><a class="dropdown-item" href="<?= base_url('home/pesanansaya') ?>" style="border-bottom: 1px solid black;"><i class="fa-solid fa-briefcase"></i>
                                    Pesanan
                                    Saya</a></li>
                            <li><a class="dropdown-item" data-toggle="modal" data-target="#logoutModal" href="#" style="border-bottom: none;"><i class="fa-solid fa-right-from-bracket"></i>Log
                                    out</a></li>
                        </ul>
                    </div>
                </div>
                            ...
                            <div class="accordion mt-3" id="<?= $pay->id_class ?>">
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingOne">
                                        <button class="accordion-button collapsed collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#<?= $pay->id_class ?>" aria-expanded="false" aria-controls="<?= $pay->id_class ?>" style="padding: 25px;font-weight: 500;font-size: 17px;">
                                            <img src="<?= base_url('assets/image/payment/') . $pay->icon ?>" width="48px" alt=""> <?= $pay->method ?>
                                        </button>
                                    </h2>
                                    <div id="<?= $pay->id_class ?>" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="<?= $pay->id_class ?>">
