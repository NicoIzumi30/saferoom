  ...
  <div class="sc1">
    <nav class="navbar navbar-expand-lg" style="background-color: transparant;">
      <div class="container-fluid">
        ...
        <div class="col-md-2">
          <button type="button" class="btn btn-lg" data-bs-toggle="modal" data-bs-target="#exampleModal" style="border-radius:9999px; background-color: #ffffff5c; color: #fff; height: 50px;">
            Gabung | Daftar
          </button>
        </div>
      </div>
            ...
            <div class="col-md-10">
              ...
              <form method="POST" action="<?= base_url('home/login') ?>">
                <div class=" mb-3">
                  ...
                  <input type="email" class="form-control" name="email" id="email" placeholder="Masukkan Email" aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
                ...
                <div class="col-md-9 mt-4 text-center mx-auto">
                  <p>
                    Belum Punya Akun? <a href="#" data-bs-toggle="modal" data-bs-target="#register">Daftar Disini</a>
                  </p>
                </div>
            ...
            <div class="col-md-10">
              ...
              <form method="POST" action="<?= base_url('home/registrasi') ?>">
                <div class=" mb-3">
                  ...
                  <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Lengkap" aria-describedby="emailHelp">
                  <?= form_error('nama', '<small class="text-danger pl-3">', '</small>') ?>
                </div>
                <div class=" mb-3">
                  <label for="email" class="form-label">Email</label>
                  <input type="text" class="form-control" name="email" id="email" placeholder="Alamat Surat Elektronik" aria-describedby="emailHelp">
                  <?= form_error('email', '<small class="text-danger pl-3">', '</small>') ?>
                </div>
                <div class=" mb-3">
                  <label for="phone" class="form-label col-12">Nomot Telpon</label>
                  <input type="tel" name="phone" id="phone" class="form-control" placeholder="Nomor Telpon" style="width: 100% !important;">
                ...
                <div class=" mb-3">
                  ...
                  <div id="pw" class="form-text">At least 8 char, use at least 1 upper and 1 lower case, 1 number, and 1
                    symbol(!@?#$%^&*-+=_)</div>
                </div>
                <div class=" mb-3">
                  ...
                  <div class="col-md-9 mt-4 text-center mx-auto">
                    <p>Dengan masuk atau membuat akun, Anda setuju dengan kami <a href="#"> Syarat & Ketentuan</a>
