      ...
      <div class="signin-signup">
        ...
        <form action="<?= base_url('home/register') ?>" method="POST" class="sign-up-form">
          ...
          <div class="input-field">
            ...
            <input type="text" name="nama" id="nama" placeholder="Full Name" value="<?= set_value('nama') ?>" />
          </div>
          ...
          <div class="input-field">
            ...
            <input type="number" name="phone" id="phone" placeholder="Telephone" value="<?= set_value('phone') ?>">
          </div>
