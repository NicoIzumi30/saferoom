                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <?php if ($order->status == 'Selesai') { ?>
                                                            <td><span class="badge text-bg-success" style="color: #fff !important;background-color: RGBA(25, 135, 84, var(--bs-bg-opacity, 1)) !important;">Selesai</span>
                                                            </td>
                                                        <?php } else {
                                                        } ?>
                                                        <td><?= date("d-M-Y", $order->created) ?></td>
                                                        <td>
                                                            <a href="<?= base_url('transaksi/delete/') . $order->id ?>" class="tombol-hapus btn btn-danger btn-sm">
