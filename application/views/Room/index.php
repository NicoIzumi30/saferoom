                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Edit Room
                                                                    Types</h5>
                ...
                <form action="<?= base_url() ?>room/index/" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="hotel" name="hotel"
                            value="<?= $getData['nama_hotel'] ?>" disabled>
                    </div>
                    <div class="form-group">
                        <label for="type">Type Room </label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="account" name="account"
                            value="<?= $this->session->userdata('email') ?>" disabled>
                    </div>
